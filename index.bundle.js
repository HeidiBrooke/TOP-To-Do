...
const loadStorage = () => {
    const storageExists = (0,_storage__WEBPACK_IMPORTED_MODULE_6__.deserializeDeckArray)('deckArray');
...
const deleteAndEraseDeck = (e) => {
    ...
    if(currentDeck.deckName === deckTitle){
        ...
        if(_logic_controlls__WEBPACK_IMPORTED_MODULE_0__.deckArray.length < 2){
            currentDeck = _logic_controlls__WEBPACK_IMPORTED_MODULE_0__.all;
        }
        else {
...
const deleteAndEraseCard = () => {
    ...
    if(currentDeck === _logic_controlls__WEBPACK_IMPORTED_MODULE_0__.all){
